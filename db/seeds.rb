...
Suggestion.create(content: "Identification documents: Driver's License")
Suggestion.create(content: "Identification documents: Passport")
Suggestion.create(content: "Identification documents: Birth Certificate")
Suggestion.create(content: "School photos")
Suggestion.create(content: "Photos of after-school activities.")
Suggestion.create(content: "Tax returns for the year")
Suggestion.create(content: "This years school reports")
Suggestion.create(content: "School photos")
Suggestion.create(content: "Health insurance policy documents")
Suggestion.create(content: "Home insurance documents")
Suggestion.create(content: "Medical reccords: vaccination certificates.")
Suggestion.create(content: "Will")
Suggestion.create(content: "Social Security card: Government-issued identification")
Suggestion.create(content: "Power of Attorney.")
Suggestion.create(content: "Property Deeds/Leases")
Suggestion.create(content: "Education: Diplomas and Degrees")
Suggestion.create(content: "Employment contracts")
